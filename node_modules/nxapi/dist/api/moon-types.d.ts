...
export declare enum SmartDeviceOS {
    IOS = "IOS",
    ANDROID = "ANDROID"
}
...
export declare enum DailySummaryResult {
    CALCULATING = "CALCULATING",
    ACHIEVED = "ACHIEVED",
    UNACHIEVED = "UNACHIEVED"
}
export declare enum ImportantInfo {
...
export declare enum MonthlySummaryTitleRankingPosition {
    UP = "UP",
    STAY = "STAY",
    DOWN = "DOWN",
    NEW = "NEW"
