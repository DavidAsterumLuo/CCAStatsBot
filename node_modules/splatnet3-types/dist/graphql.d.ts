...
export declare enum CoralWidgetExtensionAndroidRequestId {
...
declare type requests_widgetextension_android = {
...
declare type requests = requests_app & requests_app_usagi & requests_widgetextension_ios & requests_widgetextension_android;
declare type KnownRequestName = keyof typeof generated_named_types;
declare type NamedRequest<T extends KnownRequestName> = typeof generated_named_types[T][keyof typeof generated_named_types[T]];
export declare type RequestName<T extends RequestId | keyof RequestNames> = RequestNames[T];
export declare type RequestNames = {
    [R in NamedRequest<KnownRequestName> as R['id']]: R['name'];
};
export declare type RequestIds<T extends RequestId | KnownRequestName> = T extends RequestId ? RequestIds<RequestName<T>> : T extends KnownRequestName ? NamedRequest<T> extends {
    id: RequestId | KnownRequestId;
} ? NamedRequest<T>['id'] : never : never;
export declare type KnownRequestId = keyof requests;
export declare type VariablesType<T extends KnownRequestId> = requests[T][1];
export declare type ResultType<T extends KnownRequestId> = requests[T][2];
export declare type VariablesTypes = {
    [K in KnownRequestId]: VariablesType<K>;
};
export declare type ResultTypes = {
...
export declare type GraphQLResponse<T = unknown> = GraphQLSuccessResponse<T> | GraphQLErrorResponse;
export {};
