...
export declare type PhotoAlbumItemConnection = Connection<PhotoAlbumItem>;
...
export declare type CatalogExtraReward = any;
...
export declare type ChallengeJourneyConnection = Connection<ChallengeJourney>;
...
export declare type ChallengeReward = BynameReward | CardSleeveReward | WallpaperReward | IconReward | GraffitiReward | {
...
export declare type CreateCheckinHistoryPayload = any;
...
export declare type CoopHistoryGroupConnection = Connection<CoopHistoryGroup>;
export declare type CoopHistoryDetailConnection = Connection<CoopHistoryDetail>;
...
export declare type CoopBigRunRecordItemConnection = Connection<CoopBigRunRecordItem>;
export declare type CoopBigRunRecordItemEdge = Edge<CoopBigRunRecordItem>;
...
export declare type FestConnection = Connection<Fest>;
export declare type FestVoteConnection = Connection<FestVote>;
export declare type FestRankingHolderConnection = Connection<FestRankingHolder>;
export declare type FestRankingHolderEdge = Edge<FestRankingHolder>;
...
export declare type FriendConnection = Connection<Friend>;
...
export declare type HeadGearConnection = Connection<HeadGear>;
export declare type ClothingGearConnection = Connection<ClothingGear>;
export declare type ShoesGearConnection = Connection<ShoesGear>;
export declare type GearPowerConnection = Connection<GearPower>;
export declare type BrandConnection = Connection<Brand>;
...
export declare type WeaponHistoryConnection = Connection<WeaponHistory>;
...
export declare type XMatchSeasonHistoryConnection = Connection<XMatchSeasonHistory>;
export declare type XMatchSeasonHistoryEdge = Edge<XMatchSeasonHistory>;
...
export declare type HomeFooterMessage = FooterBigRunMessage | FooterFestMessage | FooterSeasonMessage | FooterLeagueMatchMessage | {
    __typename: string & never;
};
...
export declare type MyOutfitConnection = Connection<MyOutfit>;
export declare type MyOutfitEdge = Edge<MyOutfit>;
...
export declare type ReplayConnection = Connection<Replay>;
...
export declare type CoopScheduleConnection = Connection<CoopSchedule>;
...
export declare type LeagueMatchScheduleConnection = Connection<LeagueMatchSchedule>;
...
export declare type WeaponConnection = Connection<Weapon>;
export declare type WeaponCategoryConnection = Connection<WeaponCategory>;
export declare type SubWeaponConnection = Connection<SubWeapon>;
export declare type SpecialWeaponConnection = Connection<SpecialWeapon>;
...
export declare type VsStageConnection = Connection<VsStage>;
...
export declare type XRankingHolder = any;
export declare type XRankingHolderConnection = Connection<XRankingHolder>;
export declare type XRankingHolderEdge = Edge<XRankingHolder>;
...
export declare type XRankingSeasonConnection = Connection<XRankingSeason>;
export declare type Player = any;
export declare type XRanking = any;
export declare type XRankingPlayer = any;
export declare type XRankingPlayerStats = any;
export declare type UpdateFestVotePayload = any;
export interface LeagueMatchRankingSeason {
    id: string;
    leagueMatchRankingTimePeriodGroups: LeagueMatchRankingTimePeriodGroupConnection;
    seasonName: string;
}
export declare type LeagueMatchRankingSeasonConnection = Connection<LeagueMatchRankingSeason>;
export declare type LeagueMatchRankingSeasonEdge = Edge<LeagueMatchRankingSeason>;
export interface LeagueMatchRankingTimePeriodGroup {
    id: string;
    leagueMatchSetting: LeagueMatchSetting;
    timePeriods: LeagueMatchRankingTimePeriod;
}
export declare type LeagueMatchRankingTimePeriodGroupConnection = Connection<LeagueMatchRankingTimePeriodGroup>;
export declare type LeagueMatchRankingTimePeriodGroupEdge = Edge<LeagueMatchRankingTimePeriodGroup>;
...
export declare type LeagueMatchRankingDetailConnection = Connection<LeagueMatchRankingDetail>;
