 ...
 */
declare type LatestBattleHistoriesRefetchQuery_6b74405<fetchCurrentPlayer extends boolean = boolean> = ({
    currentFest: OperationFieldType<'LatestBattleHistoriesRefetchQuery', 'currentFest', {
        id: Fest['id'];
        state: Fest['state'];
    ...
    latestBattleHistories: OperationFieldType<'LatestBattleHistoriesRefetchQuery', 'vsResult', {
