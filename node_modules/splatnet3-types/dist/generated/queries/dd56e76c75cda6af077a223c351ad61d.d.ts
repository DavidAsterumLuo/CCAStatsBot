...
interface ReplayUploadedReplayListRefetchQuery_dd56e76 {
    currentFest: OperationFieldType<'ReplayUploadedReplayListRefetchQuery', 'currentFest', {
        id: Fest['id'];
        state: Fest['state'];
    ...
    replays: OperationFieldType<'ReplayUploadedReplayListRefetchQuery', 'replays', {
        nodes: LinkedFieldType<ReplayConnection, 'nodes', {
            id: Replay['id'];
