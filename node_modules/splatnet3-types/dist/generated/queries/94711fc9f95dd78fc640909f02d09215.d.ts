 ...
 */
declare type XBattleHistoriesRefetchQuery_94711fc<fetchCurrentPlayer extends boolean = boolean> = ({
    xBattleHistories: OperationFieldType<'XBattleHistoriesRefetchQuery', 'vsResult', {
...
}) & (fetchCurrentPlayer extends true ? {
    currentPlayer: ({
