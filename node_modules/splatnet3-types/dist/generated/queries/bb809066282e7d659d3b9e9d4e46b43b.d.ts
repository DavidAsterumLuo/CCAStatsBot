...
interface UpdateMyOutfitMutation_bb80906 {
    updateMyOutfit: OperationFieldType<'UpdateMyOutfitMutation', 'updateMyOutfit', {
        myOutfit: LinkedFieldType<UpdateMyOutfitPayload, 'myOutfit', {
            id: MyOutfit['id'];
        ...
        userErrors: LinkedFieldType<UpdateMyOutfitPayload, 'userErrors', {
            code: UserError['code'];
        }, true>;
    }>;
}
