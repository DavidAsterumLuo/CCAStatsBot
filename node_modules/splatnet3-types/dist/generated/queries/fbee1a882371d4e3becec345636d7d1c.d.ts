...
interface HeroHistoryQuery_fbee1a8 {
    heroRecord: OperationFieldType<'HeroHistoryQuery', 'heroRecord', {
        fullReward: LinkedFieldType<HeroRecord, 'fullReward', {
        ...
        reward: LinkedFieldType<HeroRecord, 'reward', {
            id: WallpaperReward['id'];
            downloadImages: LinkedFieldType<WallpaperReward, 'downloadImages', {
                url: DownloadImage['url'];
                variant: DownloadImage['variant'];
        ...
        sites: LinkedFieldType<HeroRecord, 'sites', {
            id: HeroSite['id'];
            clearedStages: LinkedFieldType<HeroSite, 'clearedStages', {
                bestClearTimeSec: HeroStage['bestClearTimeSec'];
                bestClearWeapon: LinkedFieldType<HeroStage, 'bestClearWeapon', {
                    category: HeroSupplyWeapon['category'];
                    image: LinkedFieldType<HeroSupplyWeapon, 'image', {
                        url: Image['url'];
                    }, false>;
            ...
            image: LinkedFieldType<HeroSite, 'image', {
                url: Image['url'];
            }, false>;
            ...
            reward: LinkedFieldType<HeroSite, 'reward', {
                id: WallpaperReward['id'];
                downloadImages: LinkedFieldType<WallpaperReward, 'downloadImages', {
                    url: DownloadImage['url'];
                    variant: DownloadImage['variant'];
