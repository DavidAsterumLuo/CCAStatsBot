...
interface CatalogRefetchQuery_02d2de8 {
    catalog: OperationFieldType<'CatalogRefetchQuery', 'catalog', {
        bonus: LinkedFieldType<Catalog, 'bonus', {
            dailyWinPoint: CatalogBonus['dailyWinPoint'];
            isFest: CatalogBonus['isFest'];
        }, false>;
        progress: LinkedFieldType<Catalog, 'progress', {
            currentPoint: CatalogProgress['currentPoint'];
            extraReward: LinkedFieldType<CatalogProgress, 'extraReward', {
                __typename: 'CatalogExtraReward';
                item: LinkedFieldType<CatalogExtraReward, 'item', {
                    id: CatalogItem['id'];
                    image: LinkedFieldType<CatalogItem, 'image', {
                        url: Image['url'];
                    }, false>;
            ...
            rewards: LinkedFieldType<CatalogProgress, 'rewards', {
                currentPoint: CatalogReward['currentPoint'];
                item: LinkedFieldType<CatalogReward, 'item', {
                    id: CatalogItem['id'];
                    ...
                    name: CatalogItem['name'];
                    primaryGearPower: LinkedFieldType<CatalogItem, 'primaryGearPower', {
