 ...
 */
declare type PagerUpdateBattleHistoriesByVsModeQuery_ac6561f<isRegular extends boolean = boolean, isBankara extends boolean = boolean, isXBattle extends boolean = boolean, isEvent extends boolean = boolean, isPrivate extends boolean = boolean> = ({
    currentFest: OperationFieldType<'PagerUpdateBattleHistoriesByVsModeQuery', 'currentFest', {
        id: Fest['id'];
        state: Fest['state'];
        teams: LinkedFieldType<Fest, 'teams', {
            id: FestTeam['id'];
            color: LinkedFieldType<FestTeam, 'color', {
                r: Color['r'];
                g: Color['g'];
                b: Color['b'];
                a: Color['a'];
    ...
    latestBattleHistories: OperationFieldType<'PagerUpdateBattleHistoriesByVsModeQuery', 'vsResult', {
        historyGroups: LinkedFieldType<VsResult, 'historyGroups', {
            nodes: LinkedFieldType<VsHistoryGroupConnection, 'nodes', {
                historyDetails: LinkedFieldType<VsHistoryGroup, 'historyDetails', {
                    nodes: LinkedFieldType<VsHistoryDetailConnection, 'nodes', {
        ...
        historyGroupsOnlyFirst: LinkedFieldType<VsResult, 'historyGroups', {
            nodes: LinkedFieldType<VsHistoryGroupConnection, 'nodes', {
                historyDetails: LinkedFieldType<VsHistoryGroup, 'historyDetails', {
                    nodes: LinkedFieldType<VsHistoryDetailConnection, 'nodes', {
                        id: VsHistoryDetail['id'];
        ...
        summary: LinkedFieldType<VsResult, 'summary', {
...
} : {}) & (isBankara extends true ? {
    bankaraBattleHistories: ({
        historyGroups: LinkedFieldType<VsResult, 'historyGroups', {
            nodes: LinkedFieldType<VsHistoryGroupConnection, 'nodes', {
                bankaraMatchChallenge: LinkedFieldType<VsHistoryGroup, 'bankaraMatchChallenge', {
    ...
    xBattleHistories: ({
        historyGroups: LinkedFieldType<VsResult, 'historyGroups', {
            nodes: LinkedFieldType<VsHistoryGroupConnection, 'nodes', {
                ...
                xMatchMeasurement: LinkedFieldType<VsHistoryGroup, 'xMatchMeasurement', {
                    ...
                    vsRule: LinkedFieldType<XMatchMeasurement, 'vsRule', {
                        id: VsRule['id'];
                        name: VsRule['name'];
                        rule: VsRule['rule'];
                    }, false>;
        ...
        summary: LinkedFieldType<VsResult, 'summary', {
            ...
            specialAverage: VsHistorySummary['specialAverage'];
            win: VsHistorySummary['win'];
            xPowerAr: LinkedFieldType<VsHistorySummary, 'xPowerAr', {
                lastXPower: XPower['lastXPower'];
            }, false>;
            xPowerCl: LinkedFieldType<VsHistorySummary, 'xPowerCl', {
                lastXPower: XPower['lastXPower'];
            }, false>;
            xPowerGl: LinkedFieldType<VsHistorySummary, 'xPowerGl', {
                lastXPower: XPower['lastXPower'];
            }, false>;
            xPowerLf: LinkedFieldType<VsHistorySummary, 'xPowerLf', {
                lastXPower: XPower['lastXPower'];
            }, false>;
        }, false>;
    } | null);
} : {}) & (isEvent extends true ? {
    eventBattleHistories: ({
        historyGroups: LinkedFieldType<VsResult, 'historyGroups', {
            nodes: LinkedFieldType<VsHistoryGroupConnection, 'nodes', {
                ...
                leagueMatchHistoryGroup: LinkedFieldType<VsHistoryGroup, 'leagueMatchHistoryGroup', {
                    leagueMatchEvent: LinkedFieldType<LeagueMatchHistoryGroup, 'leagueMatchEvent', {
                    ...
                    vsRule: LinkedFieldType<LeagueMatchHistoryGroup, 'vsRule', {
                        id: VsRule['id'];
                        name: VsRule['name'];
                        rule: VsRule['rule'];
                    }, false>;
