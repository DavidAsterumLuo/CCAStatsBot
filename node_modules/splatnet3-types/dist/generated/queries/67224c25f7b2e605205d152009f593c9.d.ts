 ...
 */
declare type PagerUpdateBattleHistoriesByVsModeQuery_67224c2<isRegular extends boolean = boolean, isBankara extends boolean = boolean, isXBattle extends boolean = boolean, isLeague extends boolean = boolean, isPrivate extends boolean = boolean> = ({
...
} : {}) & (isLeague extends true ? {
    leagueBattleHistories: ({
        historyGroups: LinkedFieldType<VsResult, 'historyGroups', {
            nodes: LinkedFieldType<VsHistoryGroupConnection, 'nodes', {
                historyDetails: LinkedFieldType<VsHistoryGroup, 'historyDetails', {
                    nodes: LinkedFieldType<VsHistoryDetailConnection, 'nodes', {
