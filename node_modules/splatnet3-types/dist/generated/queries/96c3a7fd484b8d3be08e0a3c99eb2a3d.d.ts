...
interface DetailFestRecordDetailQuery_96c3a7f {
    currentPlayer: OperationFieldType<'DetailFestRecordDetailQuery', 'currentPlayer', {
        name: CurrentPlayer['name'];
        userIcon: LinkedFieldType<CurrentPlayer, 'userIcon', {
            url: Image['url'];
        }, false>;
    }>;
    fest: OperationFieldType<'DetailFestRecordDetailQuery', 'node', ({
        __typename: string;
        id: Fest['id'];
    }) & ({
        endTime: Fest['endTime'];
        image: LinkedFieldType<Fest, 'image', {
            url: Image['url'];
        }, false>;
        isVotable: Fest['isVotable'];
        lang: Fest['lang'];
        myTeam: LinkedFieldType<Fest, 'myTeam', {
            id: FestTeam['id'];
        ...
        playerResult: LinkedFieldType<Fest, 'playerResult', {
        ...
        teams: LinkedFieldType<Fest, 'teams', {
            ...
            image: LinkedFieldType<FestTeam, 'image', {
                url: Image['url'];
            }, false>;
            myVoteState: FestTeam['myVoteState'];
            preVotes: LinkedFieldType<FestTeam, 'preVotes', {
                totalCount: FestVoteConnection['totalCount'];
            }, false>;
            result: LinkedFieldType<FestTeam, 'result', {
            ...
            role: FestTeam['role'];
            teamName: FestTeam['teamName'];
            votes: LinkedFieldType<FestTeam, 'votes', {
                totalCount: FestVoteConnection['totalCount'];
            }, false>;
        }, true>;
        title: Fest['title'];
        undecidedVotes: LinkedFieldType<Fest, 'undecidedVotes', {
            totalCount: FestVoteConnection['totalCount'];
        }, false>;
    }) & ({
        __typename: 'Fest';
