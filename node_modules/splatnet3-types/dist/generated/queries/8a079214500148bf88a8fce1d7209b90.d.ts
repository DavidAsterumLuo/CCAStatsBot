...
interface ChallengeQuery_8a07921 {
    challenge: OperationFieldType<'ChallengeQuery', 'challenge', {
        challengeJourneys: LinkedFieldType<ChallengeHome, 'challengeJourneys', {
            nodes: LinkedFieldType<ChallengeJourneyConnection, 'nodes', {
