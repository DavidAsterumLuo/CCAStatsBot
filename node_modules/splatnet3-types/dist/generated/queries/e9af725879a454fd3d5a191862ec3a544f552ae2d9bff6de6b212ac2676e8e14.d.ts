...
interface EventMatchRankingRefetchQuery_e9af725 {
    leagueMatchRankingSeasons: OperationFieldType<'EventMatchRankingRefetchQuery', 'leagueMatchRankingSeasons', {
        edges: LinkedFieldType<LeagueMatchRankingSeasonConnection, 'edges', {
            node: LinkedFieldType<LeagueMatchRankingSeasonEdge, 'node', ({
                id: LeagueMatchRankingSeason['id'];
                leagueMatchRankingTimePeriodGroups: LinkedFieldType<LeagueMatchRankingSeason, 'leagueMatchRankingTimePeriodGroups', {
                    edges: LinkedFieldType<LeagueMatchRankingTimePeriodGroupConnection, 'edges', {
                        cursor: LeagueMatchRankingTimePeriodGroupEdge['cursor'];
                        node: LinkedFieldType<LeagueMatchRankingTimePeriodGroupEdge, 'node', {
                            __typename: 'LeagueMatchRankingTimePeriodGroup';
                            id: LeagueMatchRankingTimePeriodGroup['id'];
                            leagueMatchSetting: LinkedFieldType<LeagueMatchRankingTimePeriodGroup, 'leagueMatchSetting', {
                                leagueMatchEvent: LinkedFieldType<LeagueMatchSetting, 'leagueMatchEvent', {
                                    id: LeagueMatchEvent['id'];
                                    name: LeagueMatchEvent['name'];
                                }, false>;
                                vsRule: LinkedFieldType<LeagueMatchSetting, 'vsRule', {
                                    id: VsRule['id'];
                                    name: VsRule['name'];
                                    rule: VsRule['rule'];
                                }, false>;
                            }, false>;
                            timePeriods: LinkedFieldType<LeagueMatchRankingTimePeriodGroup, 'timePeriods', {
                    ...
                    pageInfo: LinkedFieldType<LeagueMatchRankingTimePeriodGroupConnection, 'pageInfo', {
