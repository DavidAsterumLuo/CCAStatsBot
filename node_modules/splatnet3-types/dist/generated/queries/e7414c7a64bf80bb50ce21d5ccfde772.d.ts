...
interface JourneyChallengeDetailRefetchQuery_e7414c7 {
    challengeHome: OperationFieldType<'JourneyChallengeDetailRefetchQuery', 'challenge', ({
        currentPaintPoint: ChallengeHome['currentPaintPoint'];
    }) & (unknown)>;
    journey: OperationFieldType<'JourneyChallengeDetailRefetchQuery', 'node', ({
        __typename: string;
        id: ChallengeJourney['id'];
    }) & ({
        challenges: LinkedFieldType<ChallengeJourney, 'challenges', {
            id: Challenge['id'];
            challengeNumber: Challenge['challengeNumber'];
            desc: Challenge['desc'];
            goalPoint: Challenge['goalPoint'];
            image: LinkedFieldType<Challenge, 'image', {
                url: Image['url'];
            }, false>;
            isSupported: Challenge['isSupported'];
            name: Challenge['name'];
            reward: LinkedFieldType<Challenge, 'reward', ({
                __typename: string;
                ...
                sampleImage: LinkedFieldType<CardSleeveReward, 'sampleImage', {
                    url: Image['url'];
                }, false>;
            }) & ({
                __typename: 'CardSleeveReward';
            }) & ({
                downloadImages: LinkedFieldType<WallpaperReward, 'downloadImages', {
                    url: DownloadImage['url'];
                    variant: DownloadImage['variant'];
                }, true>;
                name: WallpaperReward['name'];
                sampleImage: LinkedFieldType<WallpaperReward, 'sampleImage', {
                    url: Image['url'];
                }, false>;
            }) & ({
                __typename: 'WallpaperReward';
            }) & ({
                downloadIcons: LinkedFieldType<IconReward, 'downloadIcons', {
                ...
                image: LinkedFieldType<GraffitiReward, 'image', {
                    url: DownloadImage['url'];
                }, false>;
