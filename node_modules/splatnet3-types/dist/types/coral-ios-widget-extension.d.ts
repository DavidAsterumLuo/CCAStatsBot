...
export declare type CurrentPlayer_widgetEquipment = Pick<CurrentPlayer, '__typename'> & {
...
export declare type Weapon_widgetEquipment = Pick<Weapon, '__typename' | 'name'> & {
    image: Pick<Image, '__typename' | 'url'>;
    subWeapon: SubWeapon_widgetEquipment;
    specialWeapon: SpecialWeapon_widgetEquipment;
};
export declare type SubWeapon_widgetEquipment = Pick<SubWeapon, '__typename' | 'name'> & {
    image: Pick<Image, '__typename' | 'url'>;
};
export declare type SpecialWeapon_widgetEquipment = Pick<SpecialWeapon, '__typename' | 'name'> & {
    image: Pick<Image, '__typename' | 'url'>;
};
export declare type HeadGear_widgetEquipment = Pick<HeadGear, '__typename' | 'name' | 'rarity'> & {
    image: Pick<Image, '__typename' | 'url'>;
    brand: Brand_widgetEquipment;
    primaryGearPower: GearPower_widgetEquipment;
    additionalGearPowers: GearPower_widgetEquipment[];
};
export declare type ClothingGear_widgetEquipment = Pick<ClothingGear, '__typename' | 'name' | 'rarity'> & {
    image: Pick<Image, '__typename' | 'url'>;
    brand: Brand_widgetEquipment;
    primaryGearPower: GearPower_widgetEquipment;
    additionalGearPowers: GearPower_widgetEquipment[];
};
export declare type ShoesGear_widgetEquipment = Pick<ShoesGear, '__typename' | 'name' | 'rarity'> & {
    image: Pick<Image, '__typename' | 'url'>;
    brand: Brand_widgetEquipment;
    primaryGearPower: GearPower_widgetEquipment;
    additionalGearPowers: GearPower_widgetEquipment[];
};
export declare type Brand_widgetEquipment = Pick<Brand, '__typename'> & {
    image: Pick<Image, '__typename' | 'url'>;
};
export declare type GearPower_widgetEquipment = Pick<GearPower, '__typename' | 'name'> & {
    image: Pick<Image, '__typename' | 'url'>;
};
...
export declare type VsSchedule_widgetSchedules = Pick<VsSchedule, '__typename' | 'startTime' | 'endTime'> & {
...
export declare type RegularMatchSetting_widgetSchedules = Pick<RegularMatchSetting, '__typename'> & {
    vsStages: VsStage_widgetSchedules[];
};
export declare type BankaraMatchSetting_widgetSchedules = Pick<BankaraMatchSetting, '__typename'> & {
    vsStages: VsStage_widgetSchedules[];
    vsRule: Pick<VsRule, '__typename' | 'name'>;
};
export declare type XMatchSetting_widgetSchedules = Pick<XMatchSetting, '__typename'> & {
    vsStages: VsStage_widgetSchedules[];
    vsRule: Pick<VsRule, '__typename' | 'name'>;
};
export declare type LeagueMatchSetting_widgetSchedules = Pick<LeagueMatchSetting, '__typename'> & {
    vsStages: VsStage_widgetSchedules[];
    vsRule: Pick<VsRule, '__typename' | 'name'>;
};
export declare type FestMatchSetting_widgetSchedules = Pick<FestMatchSetting, '__typename'> & {
    vsStages: VsStage_widgetSchedules[];
};
export declare type VsStage_widgetSchedules = Pick<VsStage, '__typename' | 'id' | 'name'> & {
    image: Pick<Image, '__typename' | 'url'>;
};
...
export declare type PhotoAlbum_widgetLatestPhoto = Pick<PhotoAlbum, '__typename' | 'nplnUserId'> & {
    items: {
        __typename: 'PhotoAlbumItemConnection';
    } & Pick<Connection<PhotoAlbumItem_widgetLatestPhoto>, 'nodes'>;
};
export declare type PhotoAlbumItem_widgetLatestPhoto = Pick<PhotoAlbumItem, '__typename'> & {
...
export declare type VsResult_widgetLatestResults = Pick<VsResult, '__typename'> & {
    historyGroups: {
        __typename: 'VsHistoryGroupConnection';
    } & Pick<Connection<VsHistoryGroup_widgetLatestResults>, 'nodes'>;
};
export declare type VsHistoryGroup_widgetLatestResults = Pick<VsHistoryGroup, '__typename'> & {
    historyDetails: {
        __typename: 'VsHistoryDetailConnection';
    } & Pick<Connection<VsHistoryDetail_widgetLatestResults>, 'nodes'>;
};
export declare type VsHistoryDetail_widgetLatestResults = Pick<VsHistoryDetail, '__typename' | 'id' | 'judgement' | 'knockout'> & {
...
export declare type VsPlayer_widgetLatestResults = Pick<VsPlayer, '__typename'> & {
    weapon: Weapon_widgetLatestResults;
};
export declare type Weapon_widgetLatestResults = Pick<Weapon, '__typename'> & {
    image: Pick<Image, '__typename' | 'url'>;
};
export declare type VsTeam_widgetLatestResults = Pick<VsTeam, '__typename'> & {
