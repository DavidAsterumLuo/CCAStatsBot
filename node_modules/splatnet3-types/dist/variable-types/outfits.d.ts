...
export declare type CreateMyOutfitInput = MyOutfitInput;
export declare type UpdateMyOutfitInput = {
    id: string;
} & MyOutfitInput;
...
export declare type MyOutfitDetailVariables_d935d9e = MyOutfitDetailVariables;
interface request_variables_app {
...
export declare type CreateMyOutfitVariables_31ff008 = CreateMyOutfitVariables;
interface request_variables_app {
...
export declare type UpdateMyOutfitVariables_bb80906 = UpdateMyOutfitVariables;
interface request_variables_app {
...
export declare type ShareMyOutfitVariables_3ba5572 = ShareMyOutfitVariables;
interface request_variables_app {
