...
export declare type EventMatchRankingPeriodVariables_cdf4ffe = EventMatchRankingPeriodVariables;
interface request_variables_app {
...
export declare type EventMatchRankingSeasonRefetchVariables = unknown & {
    /** PageInfo.endCursor */
    cursor: string;
    /** Always 5 in the app? */
    first: number;
...
export declare type EventMatchRankingSeasonRefetchVariables_e39d7ce = EventMatchRankingSeasonRefetchVariables;
interface request_variables_app {
